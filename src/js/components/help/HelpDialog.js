      ...
      <DialogTitle>Help</DialogTitle>
        <DialogContent>
          ...
          <Typography variant="body2" paragraph>
            GML Script Wizard is a tool that automatically generates a nicely-formatted boilerplate header you can 
          ...
          <Typography variant="subheading" gutterBottom>Details (Arguments only)</Typography>
          <Typography variant="body2" paragraph>
